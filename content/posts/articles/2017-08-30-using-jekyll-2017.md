...
image:
  path: &image /../../images/using-jekyll-2017-feature.jpg
  feature: *image
  thumbnail: /../../images/using-jekyll-2017-th.jpg
cover: *image
category: articles
...
| ----       | --------     | ----------- |
| `data-src` | **Required** | Full path to image eg: `/../../images/filename.jpg`. Use absolute URLS for those hosted externally. |
| `src`      | Optional     | Full path to low-quality image eg: `/../../images/filename.jpg`. Use absolute URLS for those hosted externally. Defaults to inline transparent `.gif`. |
| `alt`      | Optional     | Image alternate text. |

**Example:**

```liquid
{% raw %}{% lazyload data-src="/../../images/my-image.jpg" src="/../../images/my-image-low-quality.jpg" alt="my lazyloaded image" %}{% endraw %}
```
